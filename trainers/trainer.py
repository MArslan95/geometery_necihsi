...
class Trainer(TrainerHelper):
    ...
    def _set_incremental_trainable_params(self, old_class_count: int):
        ...
        # ------------------------------------------------------------
        # Critical bug fix:
        # The old code called freeze_old_classifier_adaptation(...)
        # and then unfreeze_classifier_adaptation(), which re-enabled old
        # adaptation and allowed old-class drift.
        #
        # Correct order:
        #   unfreeze all adaptation first,
        #   then freeze old adaptation.
        # ------------------------------------------------------------
